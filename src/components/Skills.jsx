...
const Skills = () => {
  return (
    <div name='skills' className='bg-secondary text-beige'>
      {/* Container */}
      <div className='max-w-[950px] mx-auto p-4 flex flex-col justify-center w-full h-screen'>
        ...
        <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8 font-semibold'>
          <div className='shadow-md shadow-primary hover:scale-110 duration-500 py-4 rounded-lg'>
